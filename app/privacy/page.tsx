      ...
      <div className="max-w-4xl mx-auto relative z-10">
        ...
        <div className="glass-panel p-6 md:p-16 rounded-[2rem] md:rounded-[3rem] border border-white/10 bg-white/5 backdrop-blur-2xl">
          <div className="flex flex-col md:flex-row items-start md:items-center gap-6 mb-12 border-b border-white/10 pb-8">
             ...
             <div>
                <h1 className="text-3xl md:text-5xl font-black uppercase tracking-tighter mb-2">Privacidad</h1>
          ...
          <div className="prose prose-invert prose-lg max-w-none text-gray-300 space-y-12">
            <p className="text-lg md:text-xl leading-relaxed font-light">En DyzGO, la privacidad es parte de la experiencia. Solo usamos tus datos para hacer tu noche mejor y más segura.</p>
            
            <div>
                <h3 className="text-white text-xl md:text-2xl font-bold mb-4 flex items-center gap-3"><span className="text-neonPurple">01.</span> Información que Recopilamos</h3>
            ...
            <div>
                <h3 className="text-white text-xl md:text-2xl font-bold mb-4 flex items-center gap-3"><span className="text-neonPurple">02.</span> NameDrop y Social</h3>
            ...
            <div>
                <h3 className="text-white text-xl md:text-2xl font-bold mb-4 flex items-center gap-3"><span className="text-neonPurple">03.</span> Compartir con Productoras</h3>
            ...
            <div>
                <h3 className="text-white text-xl md:text-2xl font-bold mb-4 flex items-center gap-3"><span className="text-neonPurple">04.</span> Eliminación de Datos</h3>
